...
WebUI.setText(findTestObject('Object Repository/Login_kasirAja/input_email_email'), 'panjimart@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Login_kasirAja/input_password_password'), 'iGDxf8hSRT4=')
